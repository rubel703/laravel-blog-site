<header class="s-header">
    ...
    <div class="s-header__logo">
        <a class="logo" href="{{ route('home') }}">
            <span style="font-size: 28px;color:red;font-weight:bold;margin-left:-10px;">rubel-blog</span>
            {{-- <img src="{{asset('assets/frontend-assets/')}}/images/logo.svg" alt="Homepage"> --}}
        </a>
    </div>
    ...
    <div class="row s-header__navigation">
        ...
        <nav class="s-header__nav-wrap">
            ...
            <ul class="s-header__nav" style="margin-left: 15px;">
                <li class="current"><a href="{{ route('home') }}" style="font-weight: bold;">Home</a></li>
